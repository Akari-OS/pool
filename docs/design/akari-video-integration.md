...
> **バージョン**: v0.1 Draft
> **最終更新**: 2026-04-08
> **対象**: AKARI Video (`~/_project/PJ26c12_AkariVideo/`) の Pool モジュールを AkariPool に置き換える
...
```
~/_project/PJ26c12_AkariVideo/src-tauri/src/
...
```
AKARI Video (~/_project/PJ26c12_AkariVideo/)
├── src-tauri/src/
...
`PJ26c12_AkariVideo/src-tauri/Cargo.toml`:
```toml
[dependencies]
akari-pool-core = { path = "../../PJ26c23_AkariPool/crates/pool-core" }
akari-pool-workspace = { path = "../../PJ26c23_AkariPool/crates/pool-workspace" }
```
